<header class="text-2xl font-sans font-bold pl-2 py-5 mx-auto w-4/5">Search Results</header>
...
<?php else: ?>
    <p class="text-gray-500 text-center mt-4">No results found for "<?= htmlspecialchars($searchQuery) ?>"</p>
<?php endif; ?>
